...
describe('TornadoPool', function () {
  ...
  it('should register and deposit', async function () {
    // let start = "0x2fe54c60d3acabf3343a35b6eba15db4821b340f76e741e2249685ed4899af6c";
    // for(let i = 1; i < 33; i++) {
    //   start = poseidonHash2(start, start);
    //   // print else if (i == 1) return bytes32(start);
    //   console.log('else if (i == ' + i + ') return bytes32(' + start.toHexString() + ');');
    // }
  ...
  xit('should withdraw with L1 fee', async function () {
  ...
  xit('should set L1FeeReceiver on L1Unwrapper contract', async function () {
